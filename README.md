...
Each item includes standard marketplace attributes such as category, brand, and price, alongside sustainability-oriented information including materials, origin, and reuse potential.
...
Instead of functioning as a passive marketplace, LookBook experiments with using information, filtering, and recommendations to help users make more conscious purchasing decisions.
...
* sustainability-related item attributes;
* an EcoScore system;
* estimated environmental impact avoided through reuse;
* filtering based on item characteristics;
* recommendation-oriented logic;
* emphasis on second-hand and circular consumption.
...
* sustainability-oriented scoring logic.
...
Ogni articolo include i normali attributi di un marketplace, come categoria, brand e prezzo, insieme a informazioni orientate alla sostenibilità, tra cui materiali, provenienza e potenziale di riutilizzo.
...
Invece di funzionare come una piattaforma passiva, LookBook sperimenta l'utilizzo di informazioni, filtri e raccomandazioni per aiutare gli utenti a compiere scelte di acquisto più consapevoli.
...
* attributi degli articoli legati alla sostenibilità;
* un sistema EcoScore;
* una stima dell'impatto ambientale evitato attraverso il riutilizzo;
* filtri basati sulle caratteristiche degli articoli;
* logiche orientate alla raccomandazione;
* attenzione al second-hand e al consumo circolare.
...
* logica condizionale;
* funzioni modulari;
* gestione e filtraggio degli articoli;
* navigazione tramite menu interattivo;
* logiche di scoring orientate alla sostenibilità.
